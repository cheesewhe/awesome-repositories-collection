...
**XC04D** — Plataforma de automatización de hogares de código abierto. Centro hogareño inteligente con control de dispositivos, automatización y amplio ecosistema de integración.
...
**[curlie](https://github.com/rs/curlie)** — Curl moderno con interfaz similar a httpie. Combina la potencia de curl con la sintaxis fácil de usar de httpie.
...
- **[share](https://github.com/schollz/share)** — Transferencia de archivos cifrados final a extremo a través de la web o CLI. Garantizar el intercambio de archivos entre pares sin servidores intermediarios.
...
- **[glab](https://github.com/profclems/glab)** — GitLab CLI herramienta para gestionar cuestiones, combinar solicitudes y oleoductos directamente desde la línea de comandos.
...
**[Supabase](https://github.com/supabase/supabase)** — alternativa de base de fuego de código abierto. Plataforma completa de backend-as-a-service con suscripciones en tiempo real, autenticación y almacenamiento.
...
**[Apache Iceberg](https://iceberg.apache.org)** — Formato de mesa abierta para los datos grandes. El formato de alto rendimiento de Google para grandes conjuntos de datos analíticos con transacciones ACID.
...
- **[Documize community](https://github.com/documize/community)** — Base de conocimiento auto hospedado con funcionalidad wiki. Organizar documentación, runbooks y conocimientos de equipo en un solo lugar.
...
**[LangChain](https://github.com/hwchase17/langchain)** — Marco para desarrollar aplicaciones basadas en modelos de lenguaje. Construir chatbots, agentes y sistemas RAG.
...
**[OWASP Amass](https://github.com/owasp-amass/amass)** — Cartografía de superficie de ataque profundo y descubrimiento de activos. Cartografía de redes de organizaciones a través de chatarra y API.
...
**[Ory](https://github.com/ory)** — Plataforma de gestión de la identidad y el acceso nativa en la nube. Solución IAM de grado empresarial con opciones auto hospedas e integraciones extensas.
...
**Computer Vision &amp; AI:**
- **[Supervision](./projects-ideas/supervision.md)** — Marco universal de Python para la visión informática que proporciona bloques de construcción reutilizables para proyectos de CV modernos.
- **[car-counter](./projects-ideas/car-counter.md)** — Herramienta Python de código abierto para contar los vehículos automáticos en vídeos de tráfico usando visión de computadora.
...
- **[Awesome-Spiking-Neural-Networks](https://github.com/TheBrainLab/Awesome-Spiking-Neural-Networks)** — Lista curada de investigación, herramientas y recursos de red neuronal. Colección completa para la computación neuromorfo y la IA inspirada en el cerebro.
...
**[awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)** — Lista curada de reglas de cursor para auxiliares de codificación AI. Las mejores prácticas y configuraciones para herramientas de desarrollo impulsadas por AI.
...
**[awesome-podcasts](https://github.com/rShetty/awesome-podcasts)** — Lista curada de increíbles podcasts para desarrolladores y entusiastas de la tecnología. Los mejores podcasts que abarcan tendencias de programación, tecnología e industria.
